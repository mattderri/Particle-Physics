...
\end{align*}
By comparing the first minimum of this function with the experiments for $^{12}$C ($q/\habr\approx1.8$\,fm$^{-1}$), we get $R\approx4.5 r_{\min}\approx2.5$\,fm, i.e. $^{12}$C is approximately a sphere of radius 2.5 fm.\\
